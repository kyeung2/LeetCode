...
public class PopulatingNextRightPointersInEachNode {
    ...
    public Node connect(Node root) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < currentLevelSize; i++) {
                ...
                if (n.left != null) {// the task is for a complete tree so if you have left you have right
                    queue.add(n.left);
                    queue.add(n.right);
                }
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new PopulatingNextRightPointersInEachNode().connect(n1));
    }
